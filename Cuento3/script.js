...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Inicia explicación.' || voz === 'Inicia, explicación.' || voz === 'Inicia la explicación.'|| voz === 'Iniciar.') {
        ...
        let utterance = new SpeechSynthesisUtterance('"¿Pero porqué debería hacerlo Simha?" preguntó Kiki, sin estar muy seguro de porqué se sentía molesto. "Porque lo quiero y soy un león", dijo él.');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
